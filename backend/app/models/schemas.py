...
class HSL(BaseModel):
    ...
    h: int = Field(..., ge=0, le=360, description="Hue (0-360)") #i.e pigment of the color (red, blue, etc). Look this up on color wheel, for example, red is 0, green is 120, blue is 240
